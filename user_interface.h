...
// Menu places
#define MENU_REQ_VEL_WHL        0
#define MENU_VEL_R_BRS             1
#define MENU_VEL_L_BRS              2
#define MENU_VEL_M_BRS             3
...
//pressure
#define MAX_REQ_VEL_WHL            255
#define REQ_VEL_WHL_STEP            5

#define MAX_REQ_VEL_R_BRS             255
#define REQ_VEL_R_BRS_STEP            5

#define MAX_REQ_VEL_L_BRS             255
#define REQ_VEL_L_BRS_STEP            5

#define MAX_REQ_VEL_M_BRS             255
#define REQ_VEL_M_BRS_STEP            5
...
int menu_place_id = MENU_REQ_VEL_WHL;
...
bool is_all_enabled = true;      // Feeder is enabled 
